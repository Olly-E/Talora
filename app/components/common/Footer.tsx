          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8 mb-12">
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-3">
                <a
                  href="https://www.instagram.com/taloraagency/"
                  target="_blank"
                ...
                <a
                  href="https://linkedin.com/company/talora-agency"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-10 h-10 rounded-full bg-white/10 hover:bg-primary flex items-center justify-center transition-all duration-300"
                  aria-label="LinkedIn"
                ...
                <a
                  href="https://www.youtube.com/@TaloraAgency"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-10 h-10 rounded-full bg-white/10 hover:bg-primary flex items-center justify-center transition-all duration-300"
                  aria-label="YouTube"
                ...
                <a
                  href="https://www.tiktok.com/@taloraagency?lang=en"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-10 h-10 rounded-full bg-white/10 hover:bg-primary flex items-center justify-center transition-all duration-300"
                  aria-label="TikTok"
