...
export const Button: React.FC<ButtonProps> = ({
  ...
  return (
    <Tag
      ...
      className={clsx(
        className,
        "rounded-full justify-center font-normal whitespace-nowrap w-fit focus:outline-blue-state disabled:cursor-not-allowed gap-2 disabled:opacity-70 cursor-pointer flex items-center transition-colors duration-100",
        variant === "primary" && "bg-primary text-black font-normal",
        ...
        variant === "none" && "bg-none border-none text-black",
      )}
      disabled={disabled}
      onClick={onClick}
      type={type}
