          ...
          <div className="order-1 lg:order-2 relative">
            ...
            <div className="relative">
              ...
              <div className="relative h-100 lg:h-137.5 rounded-3xl overflow-hidden border-4 border-white/10 shadow-2xl">
                <Image
                  src="https://img.freepik.com/free-photo/people-office-analyzing-checking-finance-graphs_23-2150377179.jpg"
              ...
              <div className="absolute -bottom-6 -left-6 bg-primary rounded-2xl p-5 shadow-xl w-56 hidden lg:block">
